...
\item Wrote and implemented an RFC that proposed a new test harness for writing API based integration tests
...
\item Ported existing TeamCity builds to CircleCI
